...
public class MainActivity extends AppCompatActivity
    ...
    //Check if app is run for the first time, if yes, show warning dialog
    ...
    public void checkUserDetails(){
        boolean checkuserDetails = getSharedPreferences(MyPREFERENCES, MODE_PRIVATE).getBoolean("isSet", false);
        if (checkuserDetails){
